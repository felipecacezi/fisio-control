                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="mb-4">
                                ...
                                <select id="patient_sex"
                                    ...
                                    >
                                    <option value="h" {{ old('patient_sex') == 'h' ? 'selected' : '' }}>Homem</option>
                                    <option value="m" {{ old('patient_sex') == 'm' ? 'selected' : '' }}>Mulher</option>
                                </select>
                                @error('patient_sex')
                                    <p class="text-red-500 text-xs mt-1">O campo sexo do paciente é obrigatório</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="patient_hma"
                                    ...
                                    required autofocus>{{ old('patient_hma') }}</textarea>
                                @error('patient_hma')
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="patient_personal_antecedents"
                                    ...
                                    required autofocus>{{ old('patient_personal_antecedents') }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="patient_drugs_in_use"
                                    ...
                                    required autofocus>{{ old('patient_drugs_in_use') }}</textarea>
