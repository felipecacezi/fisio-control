        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('patientevolution.store') }}">
                        @csrf
                        <div class="mb-4">
                            <button type="submit"
                                class="py-2 px-4 bg-blue-500 text-white rounded-md">Gravar</button>
                            <a href="{{ route('patientevolution.index', $id) }}"
                                type="submit"
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="mb-4">
                                ...
                                <input id="patient_evolution_date"
                                    ...
                                    value="{{ old('patient_evolution_date') }}"
                                    required autofocus>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="patient_evolution_description"
                                    ...
                                    rows="15"
                                    required autofocus>{{ old('patient_evolution_description') }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <select id="patient_evolution_active"
                                    ...
                                    >
                                    <option value="1" {{ old('patient_evolution_active') == 'h' ? 'selected' : '' }}>Ativo</option>
                                    <option value="0" {{ old('patient_evolution_active') == 'm' ? 'selected' : '' }}>Inativo</option>
                                </select>
